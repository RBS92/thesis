...
% Initialize
REPS          = 1;
Nd_vector     = [5]*1000;               %Number of devices
Nd_vector     = sort(Nd_vector,'descend');
Na_vector     = [2800];
% Na_vector     = [1];
% Na_vector     = [100];
Na_vector     = sort(Na_vector,'descend');
Parameters.maxReports = 5000;
...
%% Display Results
% figure
% plotyy(Ns_vector,outage, Ns_vector, probCollision);
% hold on;
% grid on;
% plot(Ns_vector,failures,'-og');
% xlabel('Number of Devices');
% ylabel('Outage [%]');
% legend('Outage without Retx (\lambda = 1)','Failures');
